    ...
    export default {
        ...
        methods: {
            ...
            mockOneData() {
                ...
                item.name = random(6);
                item.biaoti = random(6);
                item.chaxun = random(6);

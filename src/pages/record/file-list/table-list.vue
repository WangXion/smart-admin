<template>
    <div>
        ...
        <Card title="档案列表" :bordered="false" dis-hover class="ivu-mt">
                ...
                <List :loading="loading" class="ivu-mt">
                    ...
                    <ListItem v-for="(item, index) in data" :key="item.project">
                        ...
                        <div class="list-basic-list-content">
                            ...
                            <div class="list-basic-list-content-item">
                                <span>归档日期</span>
                                <p>{{ item.time | date_format('YYYY-MM-DD') }}</p>
                            </div>
        ...
        <Modal v-model="showUpdate" title="档案编辑" :loading="submitting" @on-ok="handleSubmit">
            <Form :model="newData" :rules="rules" ref="form">
                <FormItem label="档案编号：" prop="project">
                    <Input v-model="newData.project" placeholder="档案编号：" />
                </FormItem>
                <FormItem label="归档日期：" prop="time">
                    <DatePicker v-model="newData.time" type="datetime" placeholder="请选择归档日期" v-width="'100%'" />
                </FormItem>
